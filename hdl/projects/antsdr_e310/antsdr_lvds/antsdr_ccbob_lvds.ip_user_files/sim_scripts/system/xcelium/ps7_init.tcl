...
proc ps7_clock_init_data_3_0 {} {
    ...
    mask_write 0XF800012C 0x01FFCCCD 0x01ECC4CD
    mwr -force 0XF8000004 0x0000767B
}
proc ps7_ddr_init_data_3_0 {} {
    ...
    mask_write 0XF800612C 0x000FFFFF 0x00025C0F
    mask_write 0XF8006130 0x000FFFFF 0x00026C0C
    mask_write 0XF8006134 0x000FFFFF 0x00026821
    mask_write 0XF8006138 0x000FFFFF 0x00026C21
    ...
    mask_write 0XF8006158 0x000FFFFF 0x0000008C
    mask_write 0XF800615C 0x000FFFFF 0x000000A1
    mask_write 0XF8006160 0x000FFFFF 0x000000A1
    mask_write 0XF8006168 0x001FFFFF 0x000000EC
    mask_write 0XF800616C 0x001FFFFF 0x000000F0
    mask_write 0XF8006170 0x001FFFFF 0x000000EF
    mask_write 0XF8006174 0x001FFFFF 0x000000F0
    mask_write 0XF800617C 0x000FFFFF 0x000000CF
    mask_write 0XF8006180 0x000FFFFF 0x000000CC
...
proc ps7_peripherals_init_data_3_0 {} {
    ...
    mask_write 0XE000A244 0x003FFFFF 0x0008C000
    mask_write 0XE000A008 0xFFFFFFFF 0x7FFF8000
    mask_write 0XE000A248 0x003FFFFF 0x0008C000
